...
public class Vector2d extends BaseVector2d {
     ...
     * @return this
     */
    public Vector2d set(BaseVector2d other) {
        this.x = other.getX();
        this.y = other.getY();
        return this;
    }
     ...
     * @return this
     */
    public Vector2d sub(BaseVector2d other) {
        this.x -= other.getX();
        this.y -= other.getY();
        return this;
    }
     ...
     */
    public final void sub(BaseVector2d t1, BaseVector2d t2) {
     ...
     * @param other
     */
    public void min(BaseVector2d other) {
     ...
     * @param other
     */
    public void max(BaseVector2d other) {
