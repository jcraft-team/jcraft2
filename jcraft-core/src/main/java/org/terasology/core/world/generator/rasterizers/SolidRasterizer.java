...
import org.terasology.world.generation.facets.*;
...
public class SolidRasterizer implements WorldRasterizer {
    ...
    private Block ice = Blocks.ice;
    private Block stone = Blocks.cobbleStone;
    private Block sand = Blocks.sand;
    private Block grass = Blocks.grass;
    private Block snow = Blocks.snow;
