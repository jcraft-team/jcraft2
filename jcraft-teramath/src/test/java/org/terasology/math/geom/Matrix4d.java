...
public class Matrix4d extends BaseMatrix4d {
   ...
   */
    ...
    public void invert() {
        ...
        double lm00 = (m11 * c5 - m12 * c4 + m13 * c3) * invdet;
        double lm01 = (-m01 * c5 + m02 * c4 - m03 * c3) * invdet;
        double lm02 = (m31 * s5 - m32 * s4 + m33 * s3) * invdet;
        double lm03 = (-m21 * s5 + m22 * s4 - m23 * s3) * invdet;

        double lm10 = (-m10 * c5 + m12 * c2 - m13 * c1) * invdet;
        double lm11 = (m00 * c5 - m02 * c2 + m03 * c1) * invdet;
        double lm12 = (-m30 * s5 + m32 * s2 - m33 * s1) * invdet;
        double lm13 = (m20 * s5 - m22 * s2 + m23 * s1) * invdet;

        double lm20 = (m10 * c4 - m11 * c2 + m13 * c0) * invdet;
        double lm21 = (-m00 * c4 + m01 * c2 - m03 * c0) * invdet;
        double lm22 = (m30 * s4 - m31 * s2 + m33 * s0) * invdet;
        double lm23 = (-m20 * s4 + m21 * s2 - m23 * s0) * invdet;

        double lm30 = (-m10 * c3 + m11 * c1 - m12 * c0) * invdet;
        double lm31 = (m00 * c3 - m01 * c1 + m02 * c0) * invdet;
        double lm32 = (-m30 * s3 + m31 * s1 - m32 * s0) * invdet;
        double lm33 = (m20 * s3 - m21 * s1 + m22 * s0) * invdet;
