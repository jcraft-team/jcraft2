...
public class Quat4d extends BaseQuat4d {
    ...
    /**
     * Sets the value of this BaseQuat4d to the value of Quat4d t1.
     * @param t1 the Quat4d to be copied
     */
     ...
     * @param t1 the Quat4d to be copied
     */
    public final void set(double nx, double ny, double nz, double nw) {
        this.x = nx;
        this.y = ny;
        this.z = nz;
        this.w = nw;
